...
for scene in ${scenes}; do
  ...
  g.remove -f type=raster name=SCDA_area,SZA_CM0 --q
done
...
bandsFloat32="$(g.list type=raster pattern="r_TOA_*") SZA SAA OZA OAA WV O3 NDSI BT_S7 BT_S8 BT_S9 r_TOA_S5 r_TOA_S5_rc r_TOA_S1 height SCDA_v20 SCDA_grow SCDA_clump"
