...
The GNU parallel function will be needed (Tange (2011): GNU Parallel - The Command-Line Power Tool;login: The USENIX Magazine, February 2011:42-47.). Install it with the command: 

#+BEGIN_SRC sh
sudo apt install parallel#+END_SRC
#+END_SRC
