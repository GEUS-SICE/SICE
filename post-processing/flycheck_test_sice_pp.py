...
from sice_pp import SICEPostProcessing
...
d1 = SICEPostProcessing(dataset_path=dataset_path, regions=['Greenland'])
...
d2 = SICEPostProcessing(dataset_path=dataset_path, regions=['Greenland', 'Iceland'])
...
d3 = SICEPostProcessing(dataset_path=dataset_path)
