...
from sice-popaviz import PoPAViz

dataset_path = '/path/to/SICE/data'

# %% check initialization

# one region, default variables
d1 = PoPAViz(dataset_path=dataset_path, regions=['Greenland'])
...
d2 = PoPAViz(dataset_path=dataset_path, regions=['Greenland', 'Iceland'])
...
d3 = PoPAViz(dataset_path=dataset_path)
